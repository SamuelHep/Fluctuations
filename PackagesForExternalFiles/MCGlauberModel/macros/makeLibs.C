...
void makeLibs(TString opt=""){
  ...
  gSystem->CompileMacro("src/GlauberUtil.cxx","k-");
  gSystem->CompileMacro("src/HistMaker.cxx","k-");
  
  gSystem->CompileMacro("src/GlauberModel.cxx","k-");
  gSystem->CompileMacro("src/FindBestFitNegativeBinomialParameters.cxx","k-");
  //gSystem->CompileMacro("src/FindBestFitNegativeBinomialParametersSaveAll.cxx","k-");
  ...
  gSystem->CompileMacro("src/GlauberMinimizer.cxx","k-");
}
