...
GlauberClass::GlauberClass(){
  ...
  xHardSoft = 0.4; //Default from Physical Review C, 70(2):021902 2004
...
//______________________________________________________________________
Double_t GlauberClass::GetEfficiency(Double_t Npart){
  ...
  return Npart*0.000266 + 0.332821;

}

//______________________________________________________________________
Double_t GlauberClass::ProduceParticles(TH1D * nbdHist,Bool_t useTrackingEfficiency){
  ...
  Double_t m = xHardSoft*nBinaryCollisions + (1.0-xHardSoft)*nParticipants*0.5;
  //cout<<"Hardness Parameter: "<<xHardSoft<<endl;  
//Where the value xHardSoft = .12 (default) is a good description for BES energies
  ...
  for (Int_t iBinColl=0; iBinColl<TMath::CeilNint(m); iBinColl++){
    totalParticlesProduced += (int) nbdHist->GetRandom();
  }
  ...
  if (useTrackingEfficiency){
    ...
    Double_t efficiency = GetEfficiency(nParticipants);
...
Double_t GlauberClass::ProduceParticles(Double_t x,TH1D * nbdHist, Bool_t useTrackingEfficiency){
  ...
  return ProduceParticles(nbdHist,useTrackingEfficiency);
  
}

//________________________________________________________________________
Double_t GlauberClass::ProduceParticles(Int_t nPart, Int_t nColl, TH1D * nbdHist, Double_t x, Bool_t useTrackingEfficiency){
  ...
  return ProduceParticles(x, nbdHist, useTrackingEfficiency);
