...
class GlauberClass : public TObject{
 ...
 public:
  ...
  void SetSeed(int i){ rand->SetSeed(i); }
  ...
  Double_t GetEfficiency(Double_t Npart);
  Double_t ProduceParticles(TH1D * nbdHist,Bool_t useTrackingEfficiency=false);
  Double_t ProduceParticles(Double_t x, TH1D* nbdHist, Bool_t useTrackingEfficiency=false);
  Double_t ProduceParticles(Int_t nPart, Int_t nColl, TH1D* nbdHist, Double_t x=-1, Bool_t useTrackingEfficiency=false);
  void Reset();
