...
//---------Group of EPD ring-------------------------
Int_t StEpdEpInfo::RingGroup(int ringID){
		int group = -1;
		//if     (ringID == 0 || ringID == 1 || ringID == 2 || ringID == 3) group = 0;
		//else if(ringID == 4 || ringID == 5 || ringID == 6 || ringID == 7) group = 1;
        //else if(ringID == 8 || ringID == 9 || ringID ==10 || ringID ==11) group = 2;
		//else if(ringID ==12 || ringID ==13 || ringID ==14 || ringID ==15) group = 3;
		if     (ringID == 4 || ringID == 5 || ringID == 6) group = 0;
		else if(ringID == 7 || ringID == 8 || ringID == 9) group = 1;
        else if(ringID ==10 || ringID ==11 || ringID ==12) group = 2;
		else if(ringID ==13 || ringID ==14 || ringID ==15) group = 3;
		return group;
}
